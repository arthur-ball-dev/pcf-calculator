...
def upgrade() -> None:
    ...
    columns_to_add = [
        ...
        ('allows_commercial_use', sa.Column('allows_commercial_use', sa.Boolean(), server_default='1')),
        ('requires_attribution', sa.Column('requires_attribution', sa.Boolean(), server_default='0')),
        ('requires_share_alike', sa.Column('requires_share_alike', sa.Boolean(), server_default='0')),
    ]
