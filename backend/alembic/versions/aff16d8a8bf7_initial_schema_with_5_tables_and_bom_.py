...
def downgrade() -> None:
    ...
    # Drop indexes for calculation_details (if_exists for safety during multi-migration downgrade)
    op.drop_index('idx_detail_component', table_name='calculation_details', if_exists=True)
    op.drop_index('idx_detail_calc', table_name='calculation_details', if_exists=True)

    # Drop indexes for pcf_calculations
    op.drop_index('idx_calc_status', table_name='pcf_calculations', if_exists=True)
    op.drop_index('idx_calc_date', table_name='pcf_calculations', if_exists=True)
    op.drop_index('idx_calc_product', table_name='pcf_calculations', if_exists=True)

    # Drop indexes for bill_of_materials
    op.drop_index('idx_bom_child', table_name='bill_of_materials', if_exists=True)
    op.drop_index('idx_bom_parent', table_name='bill_of_materials', if_exists=True)

    # Drop indexes for emission_factors
    op.drop_index('idx_ef_source', table_name='emission_factors', if_exists=True)
    op.drop_index('idx_ef_geography', table_name='emission_factors', if_exists=True)
    op.drop_index('idx_ef_activity', table_name='emission_factors', if_exists=True)

    # Drop indexes for products
    op.drop_index('idx_products_finished', table_name='products', if_exists=True)
    op.drop_index('idx_products_category', table_name='products', if_exists=True)
    op.drop_index('idx_products_code', table_name='products', if_exists=True)
